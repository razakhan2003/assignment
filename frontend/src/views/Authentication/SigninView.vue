...
<template>
  <DefaultLayout>
    ...
    <DefaultAuthCard subtitle="Start for free" title="Sign In">
      <form>
        <div>
            <label  class="block m-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
        ...
        <div>
            <label  class="block m-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
